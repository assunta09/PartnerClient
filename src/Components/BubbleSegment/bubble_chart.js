...
// var d3 = require('d3'); 
// var sampledata = require('gates_money.csv');
...
//    */
//   createchart: function (selector, rawData) {
...
//     nodes = this.createNodes(rawData);
...
//                   d.year +
//                   '</span>';
//     this.floatingTooltip.showTooltip(content, d3.event);
//   },
...
//     this.floatingTooltip.hideTooltip();
//   }
...
//  displaychart: function(selector,error, data) {
//   if (error) {
//     console.log(error);
//   }

//  this.createchart(selector, data);
// }
...
//   this.setupButtons();
//   // Load the data 
//   this.displaychart(selector,error,sampledata);
